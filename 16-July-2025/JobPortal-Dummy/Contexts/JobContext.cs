...
public class JobContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Location>().HasKey(u => u.guid)
                                    .HasName("PK_Location");
        ...
        //Experiences
        modelBuilder.Entity<Experience>().HasKey(u => u.Guid)
                                    .HasName("PK_Expeience");

        modelBuilder.Entity<Experience>().HasOne(u => u.seeker)
                                          .WithMany(e => e.experiences)
                                          .HasForeignKey(u => u.SeekerId);

        //Education
                modelBuilder.Entity<Education>().HasKey(u => u.guid)
                                    .HasName("PK_Education");

        modelBuilder.Entity<Education>().HasOne(u => u.seeker)
