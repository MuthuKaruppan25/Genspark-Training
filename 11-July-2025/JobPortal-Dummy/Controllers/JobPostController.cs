...
namespace JobPortal.Controllers
{
    ...
    public class JobPostController : ControllerBase
    {
        ...
        [HttpPost("add")]
        public async Task<IActionResult> AddJobPost([FromBody] JobPostResponse jobPostDto)
        {
            if (jobPostDto == null)
        ...
        public async Task<IActionResult> GetJobPostWithPagedApplicants(Guid postId, [FromBody] PageDataDto pageDataDto)
        {
            ...
            try
            {
                var result = await _jobPostService.GetJobApplicationsByPost(postId, pageDataDto, User);
                return Ok(result);
            }
            catch (FetchDataException ex)
            {
        ...
        public async Task<IActionResult> UpdateResponsibilities(Guid postId, [FromBody] ResponsibilitiesUpdateDto updatedResponsibilities)
        {
            try
            {
        ...
        public async Task<IActionResult> UpdateRequirements(Guid postId, [FromBody]RequirementsUpdateDto updatedRequirements)
        {
            try
            {
        ...
        public async Task<IActionResult> UpdatePostSkills(Guid postId, [FromBody] SkillsUpdateDto updatedSkills)
        {
            try
            {
        ...
        public async Task<IActionResult> FilterBySalary([FromQuery] int? minSalary = null,[FromQuery] int? maxSalary = null)
        {
