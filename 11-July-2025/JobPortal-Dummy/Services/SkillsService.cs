...
public class SkillsService : ISkillsService
{
    ...
    public async Task<IEnumerable<Skill>> GetAllSkills()
    {
        try
        {
            ...
            _dataLogger.Info("Fetched all skills.");
            return skills;
        }
        catch (Exception ex)
        {
            _errorLogger.Error("Failed to fetch all skills.", ex);
            throw new FetchDataException("Unable to retrieve skills at the moment.", ex);
        }
    }
