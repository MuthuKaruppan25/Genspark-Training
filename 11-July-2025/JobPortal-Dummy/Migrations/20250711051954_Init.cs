    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Education", x => x.guid);
                    table.ForeignKey(
                        name: "FK_educations_seekers_SeekerId",
                        column: x => x.SeekerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToMonth = table.Column<int>(type: "integer", nullable: true),
                    ToYear = table.Column<int>(type: "integer", nullable: true),
                    SeekerId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Expeience", x => x.Guid);
                    table.ForeignKey(
                        name: "FK_experiences_seekers_SeekerId",
                        column: x => x.SeekerId,
                        principalTable: "seekers",
                        principalColumn: "guid",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_locations_jobPosts_JobPostId",
                        column: x => x.JobPostId,
                        principalTable: "jobPosts",
                        principalColumn: "guid",
                        onDelete: ReferentialAction.Restrict);
